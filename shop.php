        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Marketplace</h1>
                </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <?php
                    // Fetch data from seller_posts table
                    $sql = "SELECT id, item_name, description, price, contact_info, imgpath FROM seller_posts";
                    $result = $conn->query($sql);

                    if ($result->num_rows > 0) {
                        // Output data for each row
                        while ($row = $result->fetch_assoc()) {
                            // Handle imgpath (default image if no image path is provided)
                            $imgpath = !empty($row['imgpath']) ? $row['imgpath'] : 'img/default.png';
                            ...
                            <div class="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <a href="single_product.php?id=' . $row["id"] . '">
                                    ...
                                    <div class="text-center p-4 mt-3">
                                        ...
                                        <p class="mt-2">Price: Rs. ' . $row["price"] . '</p>
