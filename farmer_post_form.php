...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $target_dir = "img/"; // Directory where images will be saved
    ...
    if (in_array($imageFileType, $valid_extensions)) {
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
            // Insert post details into the database, including image path
            $query = "INSERT INTO farmer_posts (user_id, title, crop_type, farm_size, farm_location, weather_conditions, problem_description, solution_description, experience_description, imgpath, created_at)
                      VALUES ('$user_id', '$title', '$crop_type', '$farm_size', '$farm_location', '$weather_conditions', '$problem_description', '$solution_description', '$experience_description', '$target_file', NOW())";
...
<head>
    <meta charset="utf-8">
    <title>AgriNet - Farmer Post</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="post-form-container">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <label for="farm_size">Farm Size (in hectare)</label>
                ...
                <textarea name="solution_description" rows="4" required></textarea>

                <label for="experience_description">Experience Description</label>
                <textarea name="experience_description" rows="4" required></textarea>
