        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <!-- Researcher Form -->
                    <div id="farmer">
                        <h2 class="form-heading">Researcher Form</h2>
                        <form method="POST" action="researcher_form_process.php" class="styled-form">
                            <label for="full_name" class="form-label">Full Name:</label>
                            <input type="text" name="full_name" required class="form-input"><br>

                            <label for="affiliation" class="form-label">Affiliation:</label>
                            <input type="text" name="affiliation" required class="form-input"><br>

                            <label for="research_field" class="form-label">Research Field:</label>
                            <input type="text" name="research_field" required class="form-input"><br>

                            <label for="published_papers" class="form-label">Published Papers:</label>
                            <input type="text" name="published_papers" required class="form-input"><br>
