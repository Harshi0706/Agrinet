        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Login</h1>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action="login_action.php"
                            ...
                            <button type="submit"
                                style="width: 100%; padding: 10px; background-color:  #00B98E; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;">Login</button>
                            <br><br>
