...
// Correct the query to join with the agriculture_experts table
$query = "SELECT expert_posts.*, agriculture_experts.full_name 
          FROM expert_posts 
          INNER JOIN agriculture_experts ON expert_posts.user_id = agriculture_experts.user_id 
          WHERE expert_posts.id = $post_id";
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4"><?php echo $post['topic']; ?></h1>
                    <hr>
                    <h6>by</h6>
                ...
                <div class="col-md-6 animated fadeIn">
                    <img class="img-fluid"
                        src="<?php echo !empty($post['imgpath']) ? $post['imgpath'] : 'img/property-2.png'; ?>" alt="">
                </div>
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="tab-content">
                    ...
                    <h4>Advice</h4>
                    <p><?php echo $post['advice']; ?></p>
                    <hr>
                    <h4>Related References</h4>
                    <p><?php echo $post['related_references']; ?></p>
                    <hr>
                    <h4>Case Studies</h4>
                    <p><?php echo $post['case_studies']; ?></p>
