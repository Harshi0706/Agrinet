        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <!-- Researcher Form -->
                    <div id="farmer">
                        <h2 class="form-heading">Seller Form</h2>
                        <form method="POST" action="seller_form_process.php" class="styled-form">
                            <label for="full_name" class="form-label">Full Name:</label>
                            <input type="text" name="full_name" required class="form-input"><br>

                            <label for="business_name" class="form-label">Business Name:</label>
                            <input type="text" name="business_name" required class="form-input"><br>
                            ...
                            <input type="text" name="products_sold" required class="form-input"><br>
