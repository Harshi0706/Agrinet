        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Sign up</h1>
                    <h5>To continue please sign up.</h5>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action="signup_step1.php"
                            style="max-width: 400px; margin: auto; padding: 20px; border: 1px solid #ccc; border-radius: 10px; background-color: #f9f9f9;">
                            <label for="email"
                                style="display: block; margin-bottom: 10px; font-size: 16px;">Email:</label>
                            <input type="email" name="email" required
                                style="width: 100%; padding: 10px; margin-bottom: 20px; border: 1px solid #ddd; border-radius: 5px;">

                            <label for="password"
                                style="display: block; margin-bottom: 10px; font-size: 16px;">Password:</label>
                            <input type="password" name="password" required
                                style="width: 100%; padding: 10px; margin-bottom: 20px; border: 1px solid #ddd; border-radius: 5px;">

                            <button type="submit"
                                style="width: 100%; padding: 10px; background-color:  #00B98E; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;">Sign
                                Up</button>
                            <br><br>
