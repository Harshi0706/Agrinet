        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <!-- Researcher Form -->
                    <div id="farmer">
                        <h2 class="form-heading">Normal Form</h2>
                        <form method="POST" action="user_form_process.php" class="styled-form">
                            ...
                            <input type="text" name="user_location" required class="form-input"><br>

                            <label for="fav_topics" class="form-label">Favourite Topics:</label>
                            <input type="text" name="fav_topics" required class="form-input"><br>
