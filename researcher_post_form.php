...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $research_results = $_POST['research_results'];
    ...
    // Insert data into researcher_posts table along with the image path
    $query = "INSERT INTO researcher_posts (user_id, research_title, research_field, research_methodology, research_results, publication_link, conclusion, imgpath, created_at)
              VALUES ('$user_id', '$research_title', '$research_field', '$research_methodology', '$research_results', '$publication_link', '$conclusion', '$target_file', NOW())";
...
<head>
    <meta charset="utf-8">
    <title>AgriNet - Researcher Post</title>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="post-form-container">
            <h2>Create Researcher Post</h2>
            <form method="POST" action="" enctype="multipart/form-data">
                <label for="research_title">Research Title</label>
                <input type="text" name="research_title" required>

                <label for="research_field">Research Field</label>
                <input type="text" name="research_field" required>

                <label for="research_methodology">Research Methodology</label>
                <textarea name="research_methodology" rows="4" required></textarea>

                <label for="research_results">Research Results</label>
                <textarea name="research_results" rows="4" required></textarea>

                <label for="publication_link">Publication Link</label>
                <input type="text" name="publication_link" required>

                <label for="conclusion">Conclusion</label>
                <textarea name="conclusion" rows="4" required></textarea>
