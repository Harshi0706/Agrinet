...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $topic = $_POST['topic'];
    $advice = $_POST['advice'];
    $related_references = $_POST['related_references'];
    ...
    // Insert data into expert_posts table along with the image path
    $query = "INSERT INTO expert_posts (user_id, topic, advice, related_references, case_studies, imgpath, created_at)
              VALUES ('$user_id', '$topic', '$advice', '$related_references', '$case_studies', '$target_file', NOW())";
...
<head>
    <meta charset="utf-8">
    <title>AgriNet - Expert Post</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="post-form-container">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <label for="related_references">Related References</label>
                <input type="text" name="related_references" required>

                <label for="case_studies">Case Studies</label>
                <textarea name="case_studies" rows="4" required></textarea>
