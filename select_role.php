...
<head>
    <meta charset="utf-8">
    <title>AgriNet - Select Role</title>
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Select Role</h1>
                    <form method="POST" action="select_role_process.php">
                        ...
                        <br>
                        <button type="submit"
                            style="width: 100px; padding: 10px; margin-top:25px; background-color:  #00B98E; color: white; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;">Next</button>
                    </form>
                </div>
