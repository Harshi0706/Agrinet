        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Error</h1>
                    <?php
        ...
        if (isset($_GET['error'])) {
            ...
            switch ($error) {
                case 'InvalidPassword':
                    ...
                    break;
                case 'EmailNotFound':
                    echo "<p>No user found with that email. Please check your email or sign up.</p>";
                    break;
                case 'DatabaseError':
            ...
            echo "<p>No specific error message was provided.</p>";
        }
        ?>
