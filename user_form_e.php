        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <!-- Agriculture Expert Form -->
                    <div id="agriculture_expert">
                        <h2 class="form-heading">Agriculture Expert Form</h2>
                        <form method="POST" action="agri_exp_form_process.php" class="styled-form">
                            ...
                            <input type="text" name="field_expertise" required class="form-input"><br>

                            <label for="years_experience" class="form-label">Years of Experience:</label>
                            <input type="number" name="years_experience" required class="form-input"><br>
